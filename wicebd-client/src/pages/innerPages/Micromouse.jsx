        ...
        <div className="auto-container" style={{ position: 'relative', zIndex: 2, textAlign: 'center' }}>
          <motion.div initial={{ opacity: 0, y: -18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 15, maxWidth: 480, margin: '0 auto', lineHeight: 1.8 }}>
              Program your autonomous robot, navigate the maze, and race to the finish in this classic robotics challenge.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}
            ...
            <Box sx={{
              ...
              <Typography sx={{ color: 'rgba(255,255,255,0.45)', fontSize: 15, maxWidth: 420, mx: 'auto', lineHeight: 1.8 }}>
                LFR Maze Solving registrations are currently closed. Please check back later or contact us for more information.
              </Typography>
            </Box>
          </motion.div>
        </div>
