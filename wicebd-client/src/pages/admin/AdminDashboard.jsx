...
export default function AdminDashboard() {
  ...
  const projectCols = [
    ...
    { field: 'member4', headerName: 'Member 4', width: 150, renderCell: p => p.value ? <Chip label={p.value} size="small" sx={{ background: `${GREEN}15`, color: GREEN, fontSize: 11 }} /> : <span style={{ color: 'rgba(255,255,255,0.3)' }}>—</span> },
    { field: 'institution4', headerName: 'Institution 4', width: 160, renderCell: p => p.value || <span style={{ color: 'rgba(255,255,255,0.3)' }}>—</span> },
    { field: 'tshirtSize4', headerName: 'T-Shirt 4', width: 90, renderCell: p => p.value || <span style={{ color: 'rgba(255,255,255,0.3)' }}>—</span> },
    { field: 'member5', headerName: 'Member 5', width: 150, renderCell: p => p.value ? <Chip label={p.value} size="small" sx={{ background: `${GREEN}15`, color: GREEN, fontSize: 11 }} /> : <span style={{ color: 'rgba(255,255,255,0.3)' }}>—</span> },
    { field: 'institution5', headerName: 'Institution 5', width: 160, renderCell: p => p.value || <span style={{ color: 'rgba(255,255,255,0.3)' }}>—</span> },
    { field: 'tshirtSize5', headerName: 'T-Shirt 5', width: 90, renderCell: p => p.value || <span style={{ color: 'rgba(255,255,255,0.3)' }}>—</span> },
