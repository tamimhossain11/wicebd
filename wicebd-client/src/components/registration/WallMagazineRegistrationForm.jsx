                ...
                >
                    ...
                    {step === 0 && (
                        <Grid container spacing={3}>
                            ...
                            <Grid size={{ xs: 12, sm: 6 }}>
                                <ReferenceSearch type="ca" value={form.ca_code} onChange={(code) => set('ca_code', code)} disabled={!!form.club_code} />
                            </Grid>
                            <Grid size={{ xs: 12, sm: 6 }}>
                                <ReferenceSearch type="club" value={form.club_code} onChange={(code) => set('club_code', code)} disabled={!!form.ca_code} />
                            </Grid>
                        ...
                        <Grid container spacing={3}>
                            <Grid size={{ xs: 12 }}>
                                <TextField fullWidth label="Magazine Title *" name="projectTitle" value={form.projectTitle} onChange={onChange}
                                    ...
                                    helperText={errors.projectTitle || `Give your wall magazine a creative, descriptive title · ${form.projectTitle.length}/160`}
