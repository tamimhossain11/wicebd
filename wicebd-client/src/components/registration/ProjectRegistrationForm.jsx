...
export default function ProjectRegistrationForm() {
    ...
    const set = (name, value) => setForm(p => ({
        ...p, [name]: value,
        ...(name === 'competitionCategory' && value !== 'Project' ? { projectSubcategory: '' } : {}),
    ...
    const validateStep = () => {
        const errs = {};
        if (step === 0) {
            if (!form.competitionCategory) errs.competitionCategory = 'Required';
            if (form.competitionCategory === 'Project' && !form.projectSubcategory) errs.projectSubcategory = 'Required';
                    ...
                    {step === 0 && (
                        <Grid container spacing={3}>
                            <Grid item xs={12} sm={6}>
                                <FormControl fullWidth sx={f} error={!!errors.competitionCategory}>
                                    <InputLabel>Segment *</InputLabel>
                                    <Select name="competitionCategory" value={form.competitionCategory} onChange={onChange} label="Segment *" MenuProps={MP}>
                                        <MenuItem value="Project">Project</MenuItem>
                                        <MenuItem value="Megazine">Wall Magazine</MenuItem>
                                    </Select>
                                    {errors.competitionCategory && <FormHelperText>{errors.competitionCategory}</FormHelperText>}
                                </FormControl>
                            </Grid>

                            {form.competitionCategory === 'Project' && (
                                <Grid item xs={12} sm={6}>
